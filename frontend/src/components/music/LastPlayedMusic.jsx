...
const LastPlayedMusic = () => {
  return (
    <div className="flex flex-col h-full max-h-[400px] rounded-[2rem] bg-[var(--surface-container-lowest)] p-5 shadow-[var(--shadow-focus)]">
      ...
      <div className="mt-5 flex items-center gap-4 rounded-[1.75rem] bg-[var(--surface-container-low)] p-3.5">
        <div className="flex h-16 w-16 items-center justify-center rounded-[1.25rem] bg-[rgba(0,106,60,0.08)] text-[var(--primary)]">
      ...
      <div className="mt-5 flex items-center justify-between">
        <button className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-[var(--surface-container-low)] text-[var(--on-surface-variant)] transition hover:bg-[var(--surface-container-lowest)]">
          <SkipBack size={18} />
        </button>
        <button className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-[var(--primary)] text-white shadow-[0_30px_60px_rgba(0,106,60,0.18)] transition hover:bg-[var(--primary-container)]">
          <Play size={18} />
        </button>
        <button className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-[var(--surface-container-low)] text-[var(--on-surface-variant)] transition hover:bg-[var(--surface-container-lowest)]">
          <SkipForward size={18} />
